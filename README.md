...
I went through creating IPFS Hosted NFTs that uses Randomness to generate a unique NFT.

NFTs are the crests of Croatian football clubs.

Minting depends on the randomness and rarity specified in the code.
...
I only deploy the `main` tags, since i need to add my `ClubNft` contract as a consumer.
